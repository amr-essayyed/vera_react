...
export default function PurchaseOrderDetailPage() {
    ...
    const purchaseOrder: PurchaseOrder | undefined = Array.isArray(data) ? data[0] : data;
    ...
    const getStateColor = (state?: string) => {
        switch (state) {
            ...
            case "to approve": return "default";
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <h1 className="text-3xl font-bold text-gray-900">
                        {purchaseOrder.name || `Purchase Order #${params.id}`}
                    </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                <Card>
                    ...
                    <CardContent>
                        <Badge variant={getStateColor(purchaseOrder.state)}>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-green-600">
                            {formatCurrency(purchaseOrder.amount_total)}
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-lg font-semibold">
                            {formatDate(purchaseOrder.date_order)}
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-lg font-semibold">
                            {formatDate(purchaseOrder.date_planned)}
                        </div>
                    </CardContent>
                </Card>
            </div>
            ...
            <Tabs defaultValue="details" className="w-full">
                            ...
                            <CardContent>
                                <div>
                                    ...
                                    <p className="text-sm mt-2 whitespace-pre-wrap">
                                        {purchaseOrder.notes || "No terms and conditions specified."}
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                ...
                <TabsContent value="lines" className="mt-6">
                    <Card>
                        ...
                        <CardContent>
                            {purchaseOrder.order_line && purchaseOrder.order_line.length > 0 ? (
                                <div className="overflow-x-auto">
                                    <table className="w-full">
                                        ...
                                        <tbody>
                                            {purchaseOrder.order_line.map((line, index) => (
                            ...
                            <div className="space-y-4">
                                <div className="border-l-2 border-blue-500 pl-4 py-2">
                                    ...
                                    <div className="text-sm text-gray-600">
                                        Purchase order was created for vendor: {vendorName}
                                    </div>
                                ...
                                {purchaseOrder.date_approve && (
                                    <div className="border-l-2 border-green-500 pl-4 py-2">
                                        ...
                                        <div className="text-sm text-gray-600">
                                            Purchase order was approved and confirmed
                                        </div>
                                        <div className="text-xs text-gray-500 mt-1">
                                            {formatDate(purchaseOrder.date_approve)}
                                        </div>
                                    </div>
                                )}
